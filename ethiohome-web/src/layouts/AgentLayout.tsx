...
import { LayoutDashboard, Users, Building2, Calendar, Wallet, User, LogOut } from 'lucide-react';
    ...
    <div className="role-layout">
      <aside className="sidebar">
        <div className="sidebar-header">
          ...
          <span className="role-badge" style={{ backgroundColor: '#10b98110', color: 'var(--secondary)' }}>Agent</span>
        </div>
        
        <nav className="sidebar-nav">
          <Link to="/agent/dashboard" className="nav-item"><LayoutDashboard size={20} /> Dashboard</Link>
          <Link to="/agent/clients" className="nav-item"><Users size={20} /> My Clients</Link>
          <Link to="/agent/managed-properties" className="nav-item"><Building2 size={20} /> Managed Listings</Link>
          <Link to="/agent/appointments" className="nav-item"><Calendar size={20} /> Appointments</Link>
          <Link to="/agent/commissions" className="nav-item"><Wallet size={20} /> Commissions</Link>
          <Link to="/agent/profile" className="nav-item"><User size={20} /> Profile</Link>
        </nav>
      ...
      <main className="content">
        <header className="content-header">
          ...
          <div className="user-info">
            <div className="avatar" style={{ backgroundColor: 'var(--secondary)' }}>A</div>
          </div>
        </header>
